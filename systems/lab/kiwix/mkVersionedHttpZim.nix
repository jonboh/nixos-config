# NOTE: taken from https://git.uninsane.org/colin/nix-files/src/commit/0d48561c26752e40930b05e0b0257f7200190b71/pkgs/by-name/zimPackages/mkVersionedHttpZim.nix
# thanks!!
#
...
in
  stdenvNoCC.mkDerivation (finalAttrs: {
    ...
    in "${position.file}:${toString position.line}";
  })

  ...
  programs.librewolf = {
    ...
    policies = {
      ExtensionSettings = {
        ...
        # In order to check the ID of a addon use: https://addons.mozilla.org/api/v5/addons/addon/tridactyl-vim/ and search of `guid`
    ...
    profiles.default = {
      ...
      settings = {
        ...
        # Download handling
        "browser.download.dir" = "/home/jonboh/Downloads"; # default download dir
